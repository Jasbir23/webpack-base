...
function setFinalValue(event) {
  ...
  initialVy = swipeLength * SPEED_Y_FACTOR;
  // fixing bug
...
function createBall() {
  ...
  document.getElementById("ball") &&
    document.getElementById("ball").appendChild(ballChild);
...
function removeBall(index) {
  ...
  if (
    document.getElementById("ball") &&
    document.getElementById("ball").childNodes[index]
  )
    document
      .getElementById("ball")
      .removeChild(document.getElementById("ball").childNodes[index]);
}
