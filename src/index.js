...
//     let i = 0;
//     while (i < ballCont.childElementCount) removeBall(i);
...
//   const left_point = Bodies.circle(RIM_LEFT, RIM_TOP, INFINITE_MASS_RADIUS, {
//     isStatic: true,
//     collisionFilter: {
...
//   const right_point = Bodies.circle(
...
//   const ground = Bodies.rectangle(w / 2, 0.75 * h, 3 * w, 0.06 * h, {
//     isStatic: true,
//     collisionFilter: {
//       mask: defaultCategory
//     },
...
//       } else if (
//         ball.velocity.y > 0 &&
//         ball.position.y + ballRadius >= 0.6 * h
//       ) {
...
//   const gameEndLottie = lottie.loadAnimation({
//     container: gameOver,
//     renderer: "svg",
//     autoplay: false,
//     loop: true,
...
//   let slideLottie = null;

//   restartBut.innerHTML = "RESTART";
//   restartBut.onclick = function restartGame(e) {
//     e.preventDefault();
//     isLoading = false;
//     gameStarted = false;
//     resultSend = false;
//     timeStopped = true;
//     mainTimer = GAME_INTERVAL;
//     initialVx = 0;
//     initialVy = 0;
//     score = 0;
//     ballRadius = w / 12;
...
//     finalScore.style.display = "none";
//     gameEndLottie.stop();
//     slideLottie && slideLottie.destroy();
//     clearInterval(timerInterval);
//     window.cancelAnimationFrame(animationFrame);
//     let i = 0;
//     while (i < ballCont.childElementCount) removeBall(i);
...
//   const fireLottie = lottie.loadAnimation({
//     container: fire,
//     renderer: "svg",
//     autoplay: false,
//     loop: true,
...
//   const rimLottie = lottie.loadAnimation({
//     container: rim,
//     renderer: "svg",
//     autoplay: false,
//     loop: false,
...
//     const ballChild = document.createElement("span");
...
//   function run() {
//     const scoreText = ("0" + score).slice(-3);
...
//     }
//     ballArray.map((ball, index) => {
//       const ballView = ballCont && ballCont.childNodes[index];
//       if (!ballView) return;
//       Body.set(ball, {
